...
#SBATCH -o PS_bac3.%A_%a.out
#SBATCH -e PS_bac3.%A_%a.err
#SBATCH --array=1-25
...
pathoscope.py MAP -numThreads $(nproc)\
 ...
 -1 $(ls $name/flexcleaned_1_prinseq_good_*.fastq) \
 -2 $(ls $name/flexcleaned_2_prinseq_good_*.fastq)
